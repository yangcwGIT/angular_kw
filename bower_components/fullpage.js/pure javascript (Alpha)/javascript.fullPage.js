...
(function(window, document, undefined){
    ...
    window.fullpage = function(element, options){
        ...
        function afterDomReady(){
            ...
            for(var i=0; i<slidesArrows.length; i++){
                addListenerMulti( slidesArrows[i], 'click touchstart', arrowsHandler);
            }
        ...
        */
        function getScrolledPosition(element){
            var position;
            if(hasClass(element, SLIDES_WRAPPER)){
        ...
        function setScrolling(element, val){
            if(!options.autoScrolling || options.scrollBar || hasClass(element, SLIDES_WRAPPER)){
        ...
        function scrollHandler(){
            ...
            if(!options.autoScrolling || options.scrollBar){
                ...
                if(!hasClass(currentSection, ACTIVE)){
                    ...
                    var prevActive = $(SECTION_ACTIVE_SEL);
    ...
    //  window.onhashchange = hashChangeHandler;
        ...
        */
        ...
        if(slidesNav !== null){
            addListenerMulti($(SLIDES_NAV_LINK_SEL), 'click touchstart', function(e){
                preventDefault(e);
        ...
        */
        function scrollPageAndSlide(destiny, slide){
            ...
            if(isNaN(destiny)){
                ...
                section = $$(SECTION_SEL)[0][(destiny -1)];
            }
